pipeline {
 ...
 steps {
 emailext to: 'sarasv1611@gmail.com', mimeType: 'text/html', subject: 'New build is waiting for your approval', body: '<html><p>A new build has been deployed, please view it by visiting <a href=http://localhost:8000/>"http://localhost:8080/"</a>, please approve this deployment by clicking on <a href=http://localhost:8080/job/DemoPyApp_Pipeline/${BUILD_NUMBER}/input/>"http://localhost:8080/${BUILD_NUMBER}/input/"</a></p></html>', attachLog: true
